...
<head>
    ...
    <title>Top Keywords - Research Database</title>
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="text-center mb-4">
                    <i class="fas fa-tags"></i> Top Keywords by Usage Count
                </h1>
                <p class="text-center text-muted mb-5">
                    Most popular research keywords and topics
                </p>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card stats-card text-center">
                    <div class="card-body">
                        ...
                        <h5>{{ $keywords->count() }} Keywords</h5>
                        <p class="mb-0">Top Research Topics</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card stats-card text-center">
                    <div class="card-body">
                        ...
                        <h5>{{ $keywords->sum('research_papers_count') }} Papers</h5>
            ...
            <div class="col-md-4">
                <div class="card stats-card text-center">
                    <div class="card-body">
                        ...
                        <h5>{{ number_format($keywords->avg('research_papers_count'), 1) }} Avg</h5>
                        <p class="mb-0">Papers per Keyword</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card keyword-card h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    ...
                                    <div class="text-end">
                                        <span class="badge bg-warning fs-6">{{ $keyword->research_papers_count }} Papers</span>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <small class="text-muted">
                                        <i class="fas fa-calendar"></i> Used in {{ $keyword->research_papers_count }} research papers
                                    </small>
                                </div>

                                <div class="mt-auto">
                                    <a href="{{ route('search.by-keyword', ['keyword_id' => $keyword->id]) }}" 
            ...
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-info text-center">
                        ...
                        <p>No keyword data available in the database.</p>
                    </div>
                </div>
            </div>
        @endif
